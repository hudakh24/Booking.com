...
module.exports = {
  up: (queryInterface, Sequelize) => {
    return queryInterface.bulkInsert("Hotels", [
      ...
      // {
      //   hotelId: uuid(),
      //   hotelName: "Awari Express",
      //   location: "Lahore",
      //   address:
      //     " Shahrah-e-Quaid-e-Azam, Garhi Shahu, Lahore, 54000, Pakistan",
      //   mobile: "+92 042 36366366",
      //   ratings: "4.2",
      //   createdAt: new Date(),
      //   updatedAt: new Date(),
      // },
      ...
      //   location: "Lahore",
      //   address: "Grand Millennium Hotel 9-Davis Road, 54000 Lahore, Pakistan",
      //   mobile: "+92 42 36301313",
      //   ratings: "4.2",
      //   createdAt: new Date(),
      //   updatedAt: new Date(),
      // },
