    ...
    return queryInterface.bulkInsert("Hotels", [
      {
        ...
        ratings: "5.0",
        images: ["uploads\\images\\ISB serena.jpg"],
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        ...
        images: ["uploads\\images\\Hotel-Margala.jpg"],
      ...
      },
      {
        ...
        ratings: "5",
        images: ["uploads\\images\\ISB Marriott.jpg"],
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        ...
        ratings: "3",
        images: ["uploads\\images\\indigo lahore.jpg"],
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
      ...
      },
      {
        ...
        ratings: "5",
        images: ["uploads\\images\\PC Lahore.jpg"],
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        ...
        ratings: "3",
        images: ["uploads\\images\\ambience boutique karachi.jpg"],
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        ...
        ratings: "4",
        images: ["uploads\\images\\Karachi Marriott.jpg"],
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        ...
        ratings: "3",
        images: ["uploads\\images\\Movenpick Karachi.JPG"],
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        ...
        ratings: "2",
        images: ["uploads\\images\\serena peshawar.jpg"],
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        ...
        ratings: "3",
        images: ["uploads\\images\\rezidor peshawar.jpg"],
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        ...
        ratings: "4",
        images: ["uploads\\images\\peshawar barracks.jpg"],
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        ...
        ratings: "5",
        images: ["uploads\\images\\Quetta Serena Hotel.jpg"],
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        ...
        ratings: "4",
        images: ["uploads\\images\\grand hotel quetta.jpg"],
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        ...
        ratings: "3",
        images: ["uploads\\images\\white hotel quetta.jpg"],
        createdAt: new Date(),
        updatedAt: new Date(),
      },
    ]);
